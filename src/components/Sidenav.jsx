  ...
  return (
    <>
      ...
      <button
        ...
        className={`visible fixed left-6 top-6 z-40 order-10 block h-10 w-10 self-center rounded bg-white opacity-100 lg:hidden ${
          isSideNavOpen
            ...
            : "visible fixed opacity-100 z-60"
        }`}
        aria-haspopup="menu"
      ...
      <aside
        id="nav-menu-2"
        aria-label="Side navigation"
            // <aside className="bg-white fixed top-0 left-0 w-72 h-screen border-r border-r-slate-200">

        className={`fixed top-18 left-0 z-40 flex w-56 flex-col border-r border-r-slate-200 bg-white transition-transform md:translate-x-0 ${
      ...
      {/*  <!-- Backdrop --> */}
      <div
        className={`fixed top-8 bottom-0 left-0 right-0 z-30 bg-slate-900/20 transition-colors sm:hidden ${
